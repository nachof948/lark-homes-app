  ...
  return (
    <div className="flex flex-wrap justify-center gap-8 items-center xl:justify-between xl:flex-nowrap lg:flex-wrap ">
      {listing?.map(propiedad => (
        <div className="flex flex-col relative w-[80vw] xl:w-[20vw] lg:w-[40vw] font-nunito cursor-pointer mb-4" onClick={() => navigateToPublication(propiedad._id)} key={propiedad._id}>
