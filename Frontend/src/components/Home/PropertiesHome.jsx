  ...
  return(
    <section className='flex flex-col mb-2'>
      <div className="flex flex-col gap-6 items-center lg:flex-row lg:justify-between">
        ...
        <p className='font-nunito w-[70vw] text-color-gris text-center text-sm xl:text-lg lg:w-[50vw] lg:text-left' >Descubre propiedades que combinan lujo, confort y ubicación privilegiada. Desde apartamentos modernos en la ciudad hasta casas encantadoras en barrios tranquilos, ofrecemos una variedad de estilos y tamaños para satisfacer tus necesidades.</p>
      </div>
